  ...
  return (
    <div className="min-h-screen bg-parchment pb-20">
      <header className="bg-surface border-b border-border px-4 py-3 flex items-center gap-3 sticky top-0 z-10">
        <Link
          href="/rak"
          className="inline-flex items-center justify-center w-10 h-10 rounded-xl text-ink-secondary hover:bg-parchment hover:text-ink transition-colors"
      ...
      <main className="max-w-lg mx-auto px-4 py-6">
        ...
        <div className="space-y-3">
          {results.map((book) => {
            ...
            return (
              <div key={book.key} className="card-elevated p-3 flex gap-3">
