...
import type { ProfilStats, FamilyMember, ActingAsInfo } from "../page";
import AvatarIcon, { AVATAR_OPTIONS } from "@/components/AvatarIcon";
import { Check, AtSign, Lock, ExternalLink, Users, Target, Trophy, Baby, Smile, Heart, User } from "lucide-react";
  ...
  return (
    <div className="space-y-5">
        ...
        <div className="space-y-3">
          ...
          {weeklyGoal > 0 && (
            <p className="text-xs text-forest bg-forest/8 rounded-lg px-3 py-2">
              Target kamu: <span className="font-semibold">{weeklyGoal} halaman per minggu</span>
            </p>
          )}
        </div>
      </div>
        ...
        <div className="card-elevated p-6 space-y-4">
          <div>
            ...
            <p className="text-xs text-ink-muted mt-1">
              Atur email dan password agar bisa login mandiri.
            </p>
          </div>
          <div>
      ...
      {stats.familyMemberCount === 1 && (
        <div className="card-elevated p-6 space-y-4">
          <h2 className="text-h3">Gabung ke keluarga</h2>
