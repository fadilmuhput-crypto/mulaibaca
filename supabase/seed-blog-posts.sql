-- Mulaibaca Blog Posts Seed Data
...
<p>Dengan Mulaibaca, Anda bisa tracking progres membaca seluruh anggota keluarga secara otomatis. Mulai dari log harian, streak, hingga review buku — semua tercatat rapi dalam satu platform.</p>',
  'Tim Mulaibaca',
