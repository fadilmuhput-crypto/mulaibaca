...
export default function ReadingModeToggle() {
  ...
  return (
    <button
      onClick={toggle}
      className="fixed bottom-4 right-4 z-50 flex items-center gap-1.5 px-3 py-2 rounded-xl border-2 shadow-brutal-sm transition-all hover:shadow-brutal text-xs font-semibold"
      style={{
