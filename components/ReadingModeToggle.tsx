...
export default function ReadingModeToggle() {
  ...
  return (
    <button
      onClick={toggle}
      className="fixed top-16 left-4 z-50 flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl border-2 shadow-brutal-xs transition-all hover:shadow-brutal-sm text-[11px] font-semibold"
      style={{
