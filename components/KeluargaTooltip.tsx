...
export default function KeluargaTooltip() {
  return (
    <div className="group relative inline-flex items-center">
      ...
      <div className="absolute left-1/2 -translate-x-1/2 bottom-full mb-2 w-56 px-3 py-2 bg-ink text-white text-xs font-medium rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
